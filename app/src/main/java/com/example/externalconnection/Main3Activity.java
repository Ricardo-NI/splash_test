...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView = (TextView) findViewById(R.id.textViewH);
        final Button button = (Button) findViewById(R.id.btnIsbnInput);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://connectionandroid.herokuapp.com/")
